...
from CF.config import TEMP_DIR, R2_EXCEL_PATH
...
# Hardcoded subcategory URLs for Bath Body Group 1
SUBCATEGORY_URLS = [
    # --- merged from original sub1 ---
    "https://www.boutiqaat.com/ar-kw/women/bath-body/body-wash-shower-gel/l/",
    "https://www.boutiqaat.com/ar-kw/women/bath-body/body-scrubs-exfoliators/l/",
    "https://www.boutiqaat.com/ar-kw/women/bath-body/bath-bombs-salts/l/",
    "https://www.boutiqaat.com/ar-kw/women/bath-body/soap/l/",
    "https://www.boutiqaat.com/ar-kw/women/bath-body/loofahs-sponges/l/",
    # --- merged from original sub2 ---
    "https://www.boutiqaat.com/ar-kw/women/bath-body/body-treatments/l/",
    "https://www.boutiqaat.com/ar-kw/women/bath-body/massage-oils-creams/l/",
    "https://www.boutiqaat.com/ar-kw/women/bath-body/deodorants/l/",
    "https://www.boutiqaat.com/ar-kw/women/bath-body/skin-care/body-sunscreen/l/",
    "https://www.boutiqaat.com/ar-kw/women/bath-body/shaving-hair-removal/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        try:
            ...
            r2_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/bath-body/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        try:
            ...
            r2_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/bath-body/excel-files"
            )
